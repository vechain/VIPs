...
A) The *sender endpoint* initiates a request. The request includes a sender address and an rlp-encoded full transaction body. The request is sent to the *authorization endpoint* (in the form of a predefined URI).
...
| body | String. RLP-encoded raw transaction. Prefixed with '0x'. |
...
Content-Type: application/json;charset=UTF-8
{
    ...
    "body": "0xf8550184aabbccdd20f840df947567d83b7b8d80addcb281a71d54fc7b3364ffed82271086000000606060df947567d83b7b8d80addcb281a71d54fc7b3364ffed824e208600000060606081808252088083bc614ec101"
}
```
...
body = '0x' + delegated_tx.encode().hex()
```
