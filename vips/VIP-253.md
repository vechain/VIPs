...
To ensure a high likelihood of the network being able to achieve finality, the mechanism will be altered slightly. Finality will require at least two-thirds of the total weighted staked VET to have proposed a block within an epoch. This update aligns the finality mechanism with the stake-based nature of DPoS, maintaining both security and liveness in the consensus protocol.
